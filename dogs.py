...
#   finding number of items in the list, sorting the list, adding/removing itmes,
#   copying a list of items into another list, and changing the datat in the list.
...
def main():
    ...
    dogs.append("Ranger")
    print("\nAddj a dog to the end of a list:")
    print(dogs)
